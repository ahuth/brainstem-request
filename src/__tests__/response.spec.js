...
describe('response', () => {
  ...
  describe('errors', () => {
    it('extracts the messages of errors returned via API request', () => {
      const json = {
        errors: [
  ...
  describe('ids', () => {
    it('extracts the ids of results returned via API request', () => {
      const json = {
        count: 3,
        results: [
          { key: 'widgets', id: '3' },
  ...
  describe('objects', () => {
    it('extracts all returned objects from an API response', () => {
      const json = {
        count: 2,
  ...
  describe('pages', () => {
    it('extracts the total number of pages available from API responses', () => {
      const json = {
